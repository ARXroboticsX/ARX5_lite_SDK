...
int main(int argc, char **argv)
{
    ...
    ros::Publisher pub_joint01 = node.advertise<sensor_msgs::JointState>("/master/joint_right", 100);
    ros::Publisher pub_pos = node.advertise<arm_control::PosCmd>("/master1_pos_back", 100);
