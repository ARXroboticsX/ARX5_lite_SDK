...
void arx_arm::update_real(ecat::EcatBase ecat_base,command cmd)
{
    ...
    else
    {
        if(control_mode == 0  ||  control_mode == 1)//解算
        {
            ...
            CAN_Handlej.control(ros_control_pos_t,motor_control_cmd,is_teach_mode,current_normal,solve.joint_torque,ecat_base,current_pos);
        }
...
void arx_arm::init_step(ecat::EcatBase ecat_base)
{
   ...
   if(temp_init>2)
   {
            ...
            CAN_Handlej.Send_moto_Cmd2(ecat_base,1, 150, 1, target_pos[0], 0,  0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,2, 150, 1, target_pos[1], 0,  0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,4, 150, 1, target_pos[2], 0,  0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,5, 30, 0.8, target_pos[3], 0, 0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,6, 25, 0.8, target_pos[4], 0, 0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,7, 10, 1, target_pos[5], 0, 0);usleep(200); 
            CAN_Handlej.Send_moto_Cmd2(ecat_base,8, 10, 1, target_pos[6], 0, 0);usleep(200); 
    ...
    else
    {
            ...
            CAN_Handlej.Send_moto_Cmd2(ecat_base,1, 0,0,0,0,0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,2, 0,0,0,0,0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,4, 0,0,0,0,0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,5, 0,0,0,0,0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,6, 0,0,0,0,0);usleep(200);
            CAN_Handlej.Send_moto_Cmd2(ecat_base,7, 0,0,0,0,0);usleep(200); 
