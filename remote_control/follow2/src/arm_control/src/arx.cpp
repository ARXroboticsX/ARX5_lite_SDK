...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_joint = node.subscribe<sensor_msgs::JointState>("/master/joint_left", 100, 
     ...
     ros::Publisher pub_joint02 = node.advertise<sensor_msgs::JointState>("/puppet/joint_left", 100);
